...
public class LANSimulation {
	...
	public static void simulate() {
		...
		network.printHTMLOn(network, buf);
		System.out.println("---------------------------------HTML------------------------------------------");
		System.out.println(buf.toString());
		System.out.println();

		buf.setLength(0);
		network.printXMLOn(network, buf);
		...
		printSimulated(network, report, document, "Andy", true);

		printSimulated(network, report, document, "UnknownPrinter", false);

		printSimulated(network, report, document, "Hans", false);

		printSimulated(network, report, document, "n1", false);
	...
	private static void printSimulated(Network network, StringWriter report, String document, String nombre,
			Boolean resultadoEsperado) {
		System.out.print("'Filip' prints '" + document + "' on '" + nombre + "' : ");
		System.out.print(network.requestWorkstationPrintsDocument("Filip", document, nombre, report));
		System.out.println(" (expects " + resultadoEsperado + ");");
	}
